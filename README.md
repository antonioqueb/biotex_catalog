...
## Clasificador por Grupos (clasificación masiva, antes "Asistente de clasificación")

Menú **Catálogo > Clasificador por Grupos**. Pantalla OWL de tres etapas para procesar
